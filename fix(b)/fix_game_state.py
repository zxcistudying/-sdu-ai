...
with open(r'd:\town4.19\town4.19\backend\game_core\game_state.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
if old_text in content:
    ...
    with open(r'd:\town4.19\town4.19\backend\game_core\game_state.py', 'w', encoding='utf-8') as f:
        f.write(content)
    print('Success!')
else:
